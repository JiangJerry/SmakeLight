...
/** @defgroup HT32F5xxxx_BOARD_Global_Variable HT32F5xxxx Board global variables
  ...
  */
  ...
  const u8 BUTTON_GPIO_ID[BUTTONn] = {WAKEUP_BUTTON_GPIO_ID, KEY1_BUTTON_GPIO_ID, KEY2_BUTTON_GPIO_ID,DC_CHRG_GPIO_ID,DC_STDBY_GPIO_ID};
  const u16 BUTTON_GPIO_PIN[BUTTONn] = {WAKEUP_BUTTON_GPIO_PIN, KEY1_BUTTON_GPIO_PIN, KEY2_BUTTON_GPIO_PIN,DC_CHRG_GPIO_PIN,DC_STDBY_GPIO_PIN};
  const AFIO_MODE_Enum BUTTON_AFIO_MODE[BUTTONn] = {WAKEUP_BUTTON_AFIO_MODE, KEY1_BUTTON_AFIO_MODE, KEY2_BUTTON_AFIO_MODE,DC_CHRG_AFIO_MODE,DC_STDBY_AFIO_MODE  };

  const u8 BUTTON_EXTI_CH[BUTTONn] = {WAKEUP_BUTTON_EXTI_CHANNEL, KEY1_BUTTON_EXTI_CHANNEL, KEY2_BUTTON_EXTI_CHANNEL,DC_CHRG_EXTI_CHANNEL,DC_STDBY_EXTI_CHANNEL};
