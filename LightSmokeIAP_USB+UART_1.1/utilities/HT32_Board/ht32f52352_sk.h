...
#define DC_CHRG_GPIO_ID             (GPIO_PB)
#define DC_CHRG_GPIO_PIN            (GPIO_PIN_5)
#define DC_CHRG_AFIO_MODE           (AFIO_FUN_GPIO)
#define DC_CHRG_EXTI_CHANNEL        (5)

#define DC_STDBY_GPIO_ID            (GPIO_PB)
#define DC_STDBY_GPIO_PIN           (GPIO_PIN_4)
#define DC_STDBY_AFIO_MODE          (AFIO_FUN_GPIO)
#define DC_STDBY_EXTI_CHANNEL       (4)
